class Test
  ...
  def initialize
    ...
    @questions = [
      ...
      "Оказавшись один на один с незнакомым человеком, Вы не вступите с ним в беседу " +
      ...
      "зрения по хорошо известному Вам вопросу, предпочитаете ли Вы промолчать и не вступать в разговор?",
  ...
  def get_user_input
    ...
    while (user_input != "0" && user_input != "1" && user_input != "2")
      puts "Введите 'да' - 2, 'иногда' - 1, 'нет' - 0"
